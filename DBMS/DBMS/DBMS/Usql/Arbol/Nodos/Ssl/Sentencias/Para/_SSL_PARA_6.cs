...
{
    /*
     * tPara + sAbreParent + SSL_ASIGNAR + sPuntoComa + VALOR + sPuntoComa + sMas + sMas + 
     *  sCierraParent + sAbreLlave + LST_CUERPO + sCierraLlave;
     */
    class _SSL_PARA_6 : _SSL_ASIGNAR
    {
        public _SSL_PARA_6(string nombre, tablaSimbolos tabla) : base(nombre, tabla)
        {
        }
