...
{
    class _SSL_SI_1 : nodoModelo
    {
        /*
         * tSi+sAbreParent+ VALOR+ sCierraParent + sAbreLlave + LST_CUERPO + sCierraLlave;
         */

        public _SSL_SI_1(string nombre, tablaSimbolos tabla) : base(nombre, tabla)
        {
        }
