...
{
    class _E_MENOS : resta
    {
        public _E_MENOS(nodoModelo hijo1, nodoModelo hijo2, tablaSimbolos tabla, token signo) : base(hijo1, hijo2, tabla, signo)
        {
        }
        ...
        */
        ...
        |--------------------------------------------------------------------------
        */
        public itemValor restaUsql(String ambito, elementoEntorno elem, token tokLinea)
        {
        ...
        {
            Console.WriteLine("[_E_MENOS]" + mensaje);
        }
    }
}
