...
{
    class _E_POT : potencia
    {
        public _E_POT(nodoModelo hijo1, nodoModelo hijo2, tablaSimbolos tabla, token signo) : base(hijo1, hijo2, tabla, signo)
        {
        }
        ...
        */
        ...
        |--------------------------------------------------------------------------
        */
        public itemValor potenciaUsql(String ambito, elementoEntorno elem, token tokLinea)
        {
        ...
        {
            Console.WriteLine("[_E_POTENCIA]" + mensaje);
        }
    }
}
