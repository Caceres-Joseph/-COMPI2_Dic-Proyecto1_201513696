...
{
    class _E_POR : multiplicacion
    {
        public _E_POR(nodoModelo hijo1, nodoModelo hijo2, tablaSimbolos tabla, token signo) : base(hijo1, hijo2, tabla, signo)
        {
        }
        ...
        */
        ...
        public override itemValor operarValorValor(elementoEntorno entorno)
        {
            ...
            return opMultiplicacion(entorno);
        }
        ...
        */
        ...
        |--------------------------------------------------------------------------
        */
        public itemValor porUsql(String ambito, elementoEntorno elem, token tokLinea)
        {
        ...
        {
            Console.WriteLine("[_E_POR]" + mensaje);
        }
