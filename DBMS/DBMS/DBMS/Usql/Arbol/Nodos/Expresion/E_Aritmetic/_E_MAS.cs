...
namespace DBMS.Usql.Arbol.Nodos.Expresion.E_Aritmetic
{
    class _E_MAS : suma
    {
        public _E_MAS(nodoModelo hijo1, nodoModelo hijo2, tablaSimbolos tabla, token signo) : base(hijo1, hijo2, tabla, signo)
        {
        }
        ...
        */
        ...
        |--------------------------------------------------------------------------
        */
        public itemValor sumaUsql(String ambito, elementoEntorno elem, token tokLinea)
        {
        ...
        {
            Console.WriteLine("[_E_MAS]" + mensaje);
        }
