...
using DBMS.Usql.Arbol.Nodos.Expresion.E_Logico;

namespace DBMS.Usql.Arbol.Nodos.Expresion.E.OpeLogico
{
    class Or : _E_OR
    {
        ...
        public itemValor opOr(String ambito, elementoEntorno elem)
        {
