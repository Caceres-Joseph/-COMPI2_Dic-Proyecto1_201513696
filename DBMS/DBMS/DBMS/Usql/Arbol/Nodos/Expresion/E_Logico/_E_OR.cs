...
{
    class _E_OR : opModelo
    {
        public _E_OR(nodoModelo hijo1, nodoModelo hijo2, tablaSimbolos tabla, token signo) : base(hijo1, hijo2, tabla, signo)
        {
        }
        ...
        public itemValor orUsql(String ambito, elementoEntorno elem, token tokLinea)
        {
            ...
            {
                tabla.tablaErrores.insertErrorSemantic("La tabla del lado izquiero del or es  nula  [ null || tabla2]", tokLinea);
                return retorno;
            }
            if (val2.tablaCartesiana == null)
            {
                tabla.tablaErrores.insertErrorSemantic("La tabla del lado derecho del or es  nula  [ tabla1 || nulo]", tokLinea);
                return retorno;
            }
            ...
            var salidaConsulta = tabla1.filas.Union(tabla2.filas, new CompararTupla());
        ...
        {
            Console.WriteLine("[E_OR]" + mensaje);
        }
