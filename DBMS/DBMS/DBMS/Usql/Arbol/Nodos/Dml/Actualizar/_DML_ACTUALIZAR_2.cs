...
{
    class _DML_ACTUALIZAR_2 : _DML_SELECCIONAR_P
    {
        /*
         *tActualizar + tTabla + LST_VAL_ID + sAbreParent + LST_VALOR + sCierraParent + tValores + sAbreParent + LST_VALOR + sCierraParent + tDonde + VALOR;
        */
        public _DML_ACTUALIZAR_2(string nombre, tablaSimbolos tabla) : base(nombre, tabla)
        {
        }
        ...
        */
        ...
        public usqlTablaCartesiana getTablaCartesiana(elementoEntorno tablaEntornos)
        {
             ...
             * +-----------------
             */
            _VALOR nodoValor = (_VALOR)hijos[3];
