...
namespace DBMS.Usql.Arbol.Elementos.Tablas.TablaUsql
{
    class usqlTablaXml
    {
        ...
        public usqlTablaXml(token nombre, tuplaTitulo titulo, tablaSimbolos tablaSimbolos)
        {
        ...
        public usqlTablaXml(usqlTabla tablaOrigen)
        {
            if (tablaOrigen == null)
            {
                println("Tabla nula");
        ...
        public usqlTablaXml(usqlTabla tablaOrigen, int indice)
        {
            this.tablaSimbolos = tablaOrigen.tablaSimbolos;
